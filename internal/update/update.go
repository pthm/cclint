...
const (
	githubAPIURL = "https://api.github.com/repos/pthm/cclint/releases/latest"
...
func check(ctx context.Context) (*Info, error) {
	...
	req.Header.Set("User-Agent", "cclint/"+version.Version)
...
func cacheDir() (string, error) {
	...
	return filepath.Join(cacheHome, "cclint"), nil
}
